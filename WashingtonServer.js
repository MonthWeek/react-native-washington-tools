...
class StaticServer {
    ...
    switch (arguments.length) {
      ...
      case 2:
        ...
        if (typeof arguments[1] === 'string') {
          ...
          this.washingtonKey = (arguments[1] && arguments[1].washingtonKey) || '';
          this.washingtonPath = (arguments[1] && arguments[1].washingtonPath) || '';
        }
        break;
      case 1:
        if (typeof arguments[0] === 'number') {
          ...
          this.washingtonKey = (arguments[0] && arguments[0].washingtonKey) || '';
          this.washingtonPath = (arguments[0] && arguments[0].washingtonPath) || '';
        }
        break;
      default:
        this.port = PORT;
  ...
  start() {
    ...
    return RNWashingtonServer.start(this.port, this.root, this.washingtonKey, this.washingtonPath, this.localOnly, this.keepAlive).then(origin => {
      this._origin = origin;
      return origin;
    });
  }
